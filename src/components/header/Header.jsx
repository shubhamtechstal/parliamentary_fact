...
useEffect(() => {
  ...
  return (
    <Box sx={{width:'100%',
    boxShadow: '0px 2px 0px rgba(0, 0, 0, 0.04)',paddingBottom:'0.8rem'}}>
    <Container >
      <Box sx={{ display: 'flex', justifyContent: 'space-between' }}>
        ...
        >
          ...
          <Text
            text={
              arrNews[trendingNews]
            }
            sx={isAnimating ? animatedTextStyle : { fontSize: '0.68rem', fontWeight: 400,cursor:'pointer', '&:hover': {
              color: '#162eb7',
            }, }} 
          />
        </Box>
