...
const StatBlock = () => (
  <Box sx={{ display: 'flex', flexDirection: 'column', gap: 0.5 }}>
    ...
    >
      ...
      <img src="/Assets/icons/shareYellowIcon.png" alt="share icon" height={30} width={30} />
  ...
  return (
    <Box sx={{ display: 'flex', flexDirection: { xs: 'column', md: 'row' } }}>
      ...
      >
        ...
        <p
          style={{ margin: '1rem 0 0 0', fontWeight: '600', fontSize: '1.6rem' }}
        >
      ...
      >
        ...
        <Box position={'relative'}>
          ...
          <img src="/Assets/icons/shareYellowIcon.png" alt="" height={30} width={30} />
        </Box>
